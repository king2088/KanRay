module.exports = [
  `CREATE TABLE datasets (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, original_file NVARCHAR(255) NOT NULL,
    ...
    source_type NVARCHAR(20) NOT NULL DEFAULT 'excel', datasource_id NVARCHAR(36), schema_name NVARCHAR(255),
    table_name_ext NVARCHAR(255), build_definition NVARCHAR(MAX), owner_id NVARCHAR(36)
  )`,
  ...
  `CREATE TABLE charts (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, dataset_id NVARCHAR(36) NOT NULL,
    chart_type NVARCHAR(50) NOT NULL, config NVARCHAR(MAX) NOT NULL, owner_id NVARCHAR(36),
  ...
  `CREATE TABLE dashboards (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, layout NVARCHAR(MAX) NOT NULL,
    gap_x INT NOT NULL DEFAULT 12, gap_y INT NOT NULL DEFAULT 12, card_style NVARCHAR(MAX) NOT NULL,
    owner_id NVARCHAR(36), created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME()
  )`,
  `CREATE TABLE users (
    id NVARCHAR(36) PRIMARY KEY, email NVARCHAR(255) NOT NULL, password_hash NVARCHAR(255) NOT NULL,
    name NVARCHAR(255) NOT NULL DEFAULT '', is_active BIT NOT NULL DEFAULT 1,
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    CONSTRAINT uq_users_email UNIQUE (email)
  )`,
  `CREATE TABLE roles (
    id NVARCHAR(36) PRIMARY KEY, code NVARCHAR(50) NOT NULL, name NVARCHAR(255) NOT NULL,
    description NVARCHAR(500) NOT NULL DEFAULT '', is_builtin BIT NOT NULL DEFAULT 0,
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    CONSTRAINT uq_roles_code UNIQUE (code)
  )`,
  `CREATE TABLE permissions (
    id NVARCHAR(36) PRIMARY KEY, code NVARCHAR(100) NOT NULL, name NVARCHAR(255) NOT NULL,
    description NVARCHAR(500) NOT NULL DEFAULT '',
    CONSTRAINT uq_permissions_code UNIQUE (code)
  )`,
  `CREATE TABLE role_permissions (
    role_id NVARCHAR(36) NOT NULL, permission_id NVARCHAR(36) NOT NULL,
    CONSTRAINT pk_role_permissions PRIMARY KEY (role_id, permission_id),
    CONSTRAINT fk_rp_role FOREIGN KEY (role_id) REFERENCES roles(id) ON DELETE CASCADE,
    CONSTRAINT fk_rp_perm FOREIGN KEY (permission_id) REFERENCES permissions(id) ON DELETE CASCADE
  )`,
  `CREATE TABLE user_roles (
    user_id NVARCHAR(36) NOT NULL, role_id NVARCHAR(36) NOT NULL,
  ...
  `CREATE TABLE audit_logs (
    id NVARCHAR(36) PRIMARY KEY, user_id NVARCHAR(36), email NVARCHAR(255), action NVARCHAR(100) NOT NULL,
  ...
  `CREATE TABLE big_screens (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, description NVARCHAR(MAX) NOT NULL DEFAULT '',
  ...
  `CREATE TABLE sync_configs (
    id NVARCHAR(36) PRIMARY KEY, datasource_id NVARCHAR(36) NOT NULL,
  ...
  `CREATE TABLE sync_logs (
    id NVARCHAR(36) PRIMARY KEY, sync_config_id NVARCHAR(36) NOT NULL,
  ...
  `CREATE TABLE dashboard_shares (
    id NVARCHAR(36) PRIMARY KEY, dashboard_id NVARCHAR(36) NOT NULL,
    token NVARCHAR(64) NOT NULL, password_hash NVARCHAR(255) NOT NULL,
    expires_at DATETIME2, is_active BIT NOT NULL DEFAULT 1, created_by NVARCHAR(36) NOT NULL,
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
  ...
  `CREATE TABLE forms (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, description NVARCHAR(1000) NOT NULL DEFAULT '',
    status NVARCHAR(20) NOT NULL DEFAULT 'draft', schema_json NVARCHAR(MAX) NOT NULL,
    submit_config NVARCHAR(MAX) NOT NULL, table_name NVARCHAR(255), dataset_id NVARCHAR(36),
    submission_seq BIGINT NOT NULL DEFAULT 0,
    owner_id NVARCHAR(36) NOT NULL, created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME()
  )`,
  'CREATE INDEX idx_forms_owner ON forms(owner_id)',
  `CREATE TABLE form_shares (
    id NVARCHAR(36) PRIMARY KEY, form_id NVARCHAR(36) NOT NULL,
    token NVARCHAR(64) NOT NULL, password_hash NVARCHAR(255) NOT NULL,
    expires_at DATETIME2, is_active BIT NOT NULL DEFAULT 1, created_by NVARCHAR(36) NOT NULL,
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
  ...
  `CREATE TABLE big_screen_shares (
    id NVARCHAR(36) PRIMARY KEY, big_screen_id NVARCHAR(36) NOT NULL,
    token NVARCHAR(64) NOT NULL, password_hash NVARCHAR(255) NOT NULL,
    expires_at DATETIME2, is_active BIT NOT NULL DEFAULT 1, created_by NVARCHAR(36) NOT NULL,
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
  ...
  `CREATE TABLE big_screen_templates (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(100) NOT NULL, description NVARCHAR(500) NOT NULL DEFAULT '',
  ...
  `CREATE TABLE api_keys (
    id NVARCHAR(36) PRIMARY KEY, name NVARCHAR(255) NOT NULL, type NVARCHAR(16) NOT NULL DEFAULT 'static',
    user_id NVARCHAR(36) NOT NULL, key_hash NVARCHAR(64) NOT NULL, key_prefix NVARCHAR(32) NOT NULL,
    scopes NVARCHAR(255) NOT NULL DEFAULT '[]', status NVARCHAR(16) NOT NULL DEFAULT 'active',
    expires_at DATETIME2, last_used_at DATETIME2, created_by NVARCHAR(36),
    created_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(), updated_at DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
