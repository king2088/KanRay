module.exports = [
  ...
  `CREATE TABLE metrics (
    ...
    owner_id NUMBER(19), created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
  ...
  `CREATE TABLE dashboards (
    ...
    card_style CLOB NOT NULL, owner_id NUMBER(19), created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
    updated_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL
  )`,
  `CREATE TABLE users (
  ...
  `CREATE TABLE data_sources (
    ...
    owner_id NUMBER(19), "mode" VARCHAR2(20) DEFAULT 'direct' NOT NULL, last_test_at TIMESTAMP,
  ...
  `CREATE TABLE big_screens (
    ...
    owner_id NUMBER(19), created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL, updated_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL
  )`,
  ...
  `CREATE TABLE dashboard_shares (
    ...
    expires_at TIMESTAMP, is_active NUMBER(1) DEFAULT 1 NOT NULL, created_by NUMBER(19) NOT NULL,
    created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL, updated_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
  ...
  `CREATE TABLE forms (
    ...
    owner_id NUMBER(19) NOT NULL, created_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
    updated_at TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL
  )`,
  ...
  `CREATE TABLE big_screen_templates (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR2(100) NOT NULL, description VARCHAR2(500) DEFAULT '' NOT NULL,
  ...
  `CREATE TABLE api_keys (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR2(255) NOT NULL, type VARCHAR2(16) DEFAULT 'static' NOT NULL,
