const drivers = [
  ...
  },
  {
    ...
    name: '南大通用 GBASE',
    category: '国产',
    family: 'mysql', // GBase 8a 兼容 MySQL 协议
    status: 'tested',
    capabilities: { test: true, browse: true, dataset: true },
    defaultPort: 5258,
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'catalog', label: 'Catalog 目录', type: 'text', required: true, default: 'tpch' },
      { name: 'schema', label: 'Schema 模式', type: 'text', required: true },
      { name: 'user', label: '用户名', type: 'text', required: true, default: 'trino' },
    ],
  },
  {
    type: 'maxcompute',
