<template>
  <div class="drag-builder">
    ...
    <div class="drag-builder__preview">
      ...
      <el-button  :loading="previewing" class="drag-builder__preview-btn" @click="runPreview">执行预览</el-button>
      <span v-if="lastError" class="drag-builder__error">{{ lastError }}</span>
      <el-table :data="previewRows"  max-height="400" empty-text="执行预览查看数据">
...
.drag-builder__panel-title { font-size: 14px; font-weight: 600; color: var(--app-text-secondary); margin-bottom: 8px; }
