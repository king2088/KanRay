<!-- 百分比面积图 (line-percent-area) - 百分比堆叠面积图 -->
...
const getChartOption = () => {
  ...
  const yAxisBase: any = getCommonYAxis(p)
  yAxisBase.max = 100
  yAxisBase.axisLabel = {
    ...yAxisBase.axisLabel,
    formatter: '{value}%'
  ...
  let seriesList = [
    { name: '搜索引擎', data: [30, 35, 40, 38, 42, 45, 50] },
    { name: '直接访问', data: [20, 22, 25, 23, 20, 18, 15] },
    { name: '邮件营销', data: [15, 13, 10, 12, 13, 12, 10] }
  ]
